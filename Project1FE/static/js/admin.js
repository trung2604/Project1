...
function setupSongManagement() {
        ...
        fileInput.onchange = async (event) => {
            ...
            if (files && files.length > 0) {
                try {
                    ...
                    const response = await fetch(`http://localhost:8000/api/songs/upload/${user.id}`, {
                        method: 'POST',
                        body: formData,
                    });
    ...
    `;
        ...
        updateForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch(`http://localhost:8000/api/songs/update/${selectedSongId}/${user.id}`, {
                    method: 'PUT',
                    body: formData,
                });
    ...
    deleteBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8000/api/songs/delete/${selectedSongId}/${user.id}`, {
                method: 'DELETE',
            });
